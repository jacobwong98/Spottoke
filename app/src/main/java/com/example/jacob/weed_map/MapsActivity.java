...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
        ...
        LatLng sydney = new LatLng(-34, 151);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Marker in Sydney").icon(BitmapDescriptorFactory.fromResource(R.drawable.poop)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));

//        BitmapDescriptor icon = BitmapDescriptorFactory.fromResource(R.drawable.poop.png);
